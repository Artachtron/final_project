...
class Animal(pg.sprite.Sprite):
    ...
    def move(self, direction: Direction) -> None:
        ...
        if self._check_next_move(next_move):
    ...
    def _check_next_move(self, next_move: Tuple[int,int]):
        return self._check_out_of_bounds(next_move)
     
    def _check_out_of_bounds(self, next_move: Tuple[int,int]):
